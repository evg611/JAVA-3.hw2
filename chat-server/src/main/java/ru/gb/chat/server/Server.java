...
//говорим что authenticationProvider создался какой-то
        this.authenticationProvider.init();
//говорим, что проинициализируйся
        try (ServerSocket serverSocket = new ServerSocket(port)) {
            ...
            //говорим, что наш authenticationProvider
    ...
    public synchronized void sendPrivateMessage(ClientHandler sender, String receiverUsername, String message) {
        ...
        sender.sendMessage("Невозможно отправить сообщение пользователю: " + receiverUsername + "Сообщение");
    }
